...
public class AppConsole {
	...
	public static void main(String[] args) {
		EntityManagerFactory factory = Persistence.createEntityManagerFactory("pu-mysql-01");
		...
		while (i != 1) {
			...
			case 2: {
				...
				Query query2 = manager.createQuery(typecheck);
				query2.setParameter("id", id);
				String type = (String) query2.getSingleResult();
